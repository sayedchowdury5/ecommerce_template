...
<head>
  ...
  <title>E-Commerce | Quick View</title>
...
<div class="container">
  ...
  <section class="mb-5">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row product-gallery mx-1 text-center">
          <div class="col-lg-3 col-md-3 col-sm-4 mb-0">
      ...
      <div class="col-md-6">
          ...
          <table class="table table-sm table-borderless">
            <tbody>
              <tr>
                ...
                <td>
                  <div class="btn-group">
                  <span><button type="button" class="btn border quantity_minus">-</button></span>
                  <input type="text" class="form-control text-center" min="0" value="1" style="max-width:70px;">
                  <span><button type="button" class="btn border quantity_pluss">+</button></span>
                  </div>
                </td>
              </tr>
              <tr>
                <th class="pb-0">Select size</th>
                <td>
                  <div class="mt-1">
                    <div class="form-check form-check-inline pl-0">
                      <input type="radio" class="form-check-input" id="xsmall" name="materialExampleRadios"
                        checked>
                    ...
                    <div class="form-check form-check-inline pl-0">
                      <input type="radio" class="form-check-input" id="xlarge" name="materialExampleRadios">
                      <label class="form-check-label small text-uppercase card-link-secondary"
                        for="xlarge">XL</label>
                    </div>
                    <div class="form-check form-check-inline pl-0">
        ...
        <button type="button" class="btn btn-dark text-warning btn-md mr-1 mb-2">Buy now</button>
      </div>
    </div>
  </section>
  <!--Section: Block Content-->
        ...
        <form action="#">
          ...
          <div>
            ...
            <div class="text-right pb-2">
              <button type="button" class="btn btn-dark text-warning">Add a review</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <section class="text-center">
    <h2 style="padding:15px;">Related Products</h2>
    <!-- Grid row -->
    <div class="row">
      <!-- Grid column -->
      ...
      <div class="col-md-6 col-lg-3 mb-5">
        <!-- Card -->
        <div class="">
          <div class="viewoverlay z-depth-2 rounded">
            <img class="img-fluid w-100" src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/15a.jpg" alt="Sample">
          </div>
          <div class="pt-4">
            <h5>Fantasy T-shirt</h5>
