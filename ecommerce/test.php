...
<?php include('nav.php'); ?>
    ...
    <div class="input-group">
              ...
              <button type="button" class="btn btn-default btn-number" disabled="disabled" data-type="minus" data-field="quant[1]">
                  <span><i class="fas fa-minus fa-sm text-primary"></i></span>
                </button>
                </span>
                <input type="text" name="quant[1]" class="form-control input-number" value="1" min="1" max="10">
                <span class="input-group-btn">
              <button type="button" class="btn btn-default btn-number" data-type="plus" data-field="quant[1]">
                  <span><i class="fas fa-plus fa-sm text-primary"></i></span>
                </button>
                </span>
            </div>
         <!-- Section: Sidebar -->
...
<div class="my-3 text-center">
          <ul class="list-inline">
            <li class="list-inline-item"><span class="btn"><h3>-</h3></span></li>
            <li class="list-inline-item"><input type="text" class="form-control text-center" maxlength="20" value="0" width="20px"></li>
            <li class="list-inline-item"><span class="btn"><h3>+</h3></span></li>   
          </ul>
        </div>
